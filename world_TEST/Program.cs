...
namespace Console_WordSkill_All
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //设置页眉   wdNormalView;//普通视图 | wdPrintView;//页面视图
            ...
            string headerfile = System.AppDomain.CurrentDomain.BaseDirectory + "课堂拍照图片.png";
            ...
            //图片文件的路径
            string filename = Environment.CurrentDirectory + "\\超人视觉.jpg";
            //要向Word文档中插入图片的位置
            ...
            //向新添加的行的单元格中添加图片
            string FileName = Environment.CurrentDirectory + "\\超人视觉.jpg";//图片所在路径
            ...
            wordDoc.Content.InsertAfter("\n");
            wordDoc.Content.InsertAfter("教练 - 就写这么多，算了吧！2019.10.27");
            ...
            wordDoc = doc;
            wordDoc.Paragraphs.Last.Range.Text += "教练-我真的不打算再写了,就写这么多吧";
